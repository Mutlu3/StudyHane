    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px' }}>
      <div className="glass-panel animate-fade-in" style={{ width: '100%', maxWidth: '420px', padding: '48px 40px', textAlign: 'center' }}>
        ...
        <p style={{ color: 'var(--text-muted)', marginBottom: '40px' }}>
          Rekabete başlamak için Google hesabınla giriş yap.
        </p>
        ...
        <p style={{ textAlign: 'center', marginTop: '32px', fontSize: '0.85rem', color: 'var(--text-light)' }}>
          Giriş yaparak <Link href="#" style={{ textDecoration: 'underline' }}>kullanım şartlarını</Link> kabul etmiş olursunuz.
        </p>
      </div>
    </div>
  );
